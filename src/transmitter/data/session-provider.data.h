...
// 4. Transmitting
#define TRANSMITTER_FRAME_RESERVED 1
#define TRANSMITTER_FRAME_READY_TO_CHECK 2
#define TRANSMITTER_FRAME_READY_TO_TRANSMITTER 3
#define TRANSMITTER_FRAME_TRANSMITTERTING 4
